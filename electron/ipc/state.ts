...
export let nativeCursorMonitorProcess: ChildProcessWithoutNullStreams | null =
  null;
...
export let cachedSystemCursorAssets: Record<string, SystemCursorAsset> | null =
  null;
...
export let lastLeftClick: { timeMs: number; cx: number; cy: number } | null =
  null;
...
import type { NativeMacWindowSource } from '@/types';

export let cachedNativeMacWindowSources: NativeMacWindowSource[] | null = null;
...
export function setNativeCaptureProcess(
  v: ChildProcessWithoutNullStreams | null
) {
...
export function setNativeCursorMonitorProcess(
  v: ChildProcessWithoutNullStreams | null
) {
...
export function setWindowsCaptureProcess(
  v: ChildProcessWithoutNullStreams | null
) {
...
export function setLastNativeCaptureDiagnostics(
  v: NativeCaptureDiagnostics | null
) {
...
export function setFfmpegCaptureProcess(
  v: ChildProcessWithoutNullStreams | null
) {
...
export function setCachedSystemCursorAssets(
  v: Record<string, SystemCursorAsset> | null
) {
...
export function setLastLeftClick(
  v: { timeMs: number; cx: number; cy: number } | null
) {
  lastLeftClick = v;
}
export function setLinuxCursorScreenPoint(
  v: { x: number; y: number; updatedAt: number } | null
) {
