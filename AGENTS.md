...
- Avoid `any`. Use `unknown` + narrowing, or existing shared types from `@quiro/utils`, `@quiro/web-domain`, generated bindings, etc.
...
- Install: `pnpm install`; setup: `pnpm env-setup` then `pnpm quiro-setup`.
