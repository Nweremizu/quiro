...
const Debug = import.meta.env.DEV
	...
	: null;
const LaunchToolbarPreview = import.meta.env.DEV
	? React.lazy(() => import("./routes/dev/launch-toolbar-preview"))
	: null;
	...
	return (
		<Routes>
			{LaunchToolbarPreview && (
				<Route
					path="/debug/launch-toolbar"
					element={<LaunchToolbarPreview />}
				/>
			)}
