import type { CaptionWordState } from "./caption-layout";
import { DEFAULT_AUTO_CAPTION_SETTINGS } from "@/types/editor";
...
export function getCaptionTargetWidth(
...
export function getCaptionWordVisualState(
