...
export const DEFAULT_WEBCAM_POSITION_PRESET: WebcamPositionPreset =
  "bottom-right";
...
export function trimsToClips(
  trims: TrimRegion[],
  totalDurationMs: number,
): ClipRegion[] {
  if (trims.length === 0)
    return [{ id: "clip-1", startMs: 0, endMs: totalDurationMs, speed: 1 }];
