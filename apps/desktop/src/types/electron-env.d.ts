...
type RendererExtensionInfo =
  import('./extensions/extensionTypes').ExtensionInfo;
type RendererExtensionReview =
  import('./extensions/extensionTypes').ExtensionReview;
type RendererMarketplaceExtension =
  import('./extensions/extensionTypes').MarketplaceExtension;
...
interface Window {
  electronAPI: {
    ...
    extensionsMarketplaceGet: (
      id: string
    ) => Promise<RendererMarketplaceExtension | null>;
