...
use quiro_recording::feeds::{self, camera::CameraFeed};
#[cfg(target_os = "macos")]
...
pub static TOOLBAR_HEIGHT: f32 = 56.0;
...
pub struct CameraPreviewState {
    ...
    pub mirrored: bool,
    #[serde(default)]
    pub background_blur: quiro_project::BackgroundBlurMode,
}
...
impl Default for CameraPreviewState {
    fn default() -> Self {
        Self {
            ...
            mirrored: false,
            background_blur: quiro_project::BackgroundBlurMode::Off,
        }
    }
}
...
impl CameraPreviewManager {
    pub fn new(app: &tauri::AppHandle) -> Self {
        Self {
            ...
            wgpu_instance: quiro_rendering::create_wgpu_instance_sync(),
        }
    }
...
// See the comment in windows.rs ShowQuiroWindow::Camera for the critical detail
...
struct Renderer {
    ...
    blur_processor: Option<quiro_camera_effects::BlurProcessor>,
...
impl Renderer {
    async fn run(
        ...
        'main_loop: loop {
            ...
            if needs_full_reconfigure {
                ...
                if state.background_blur == quiro_project::BackgroundBlurMode::Off {
    ...
    fn render_cpu_frame(
        ...
        output_width: u32,
        output_height: u32,
        blur_mode: Option<quiro_camera_effects::BlurMode>,
...
fn blur_mode_from_project(
    mode: quiro_project::BackgroundBlurMode,
