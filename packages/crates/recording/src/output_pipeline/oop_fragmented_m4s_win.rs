...
use quiro_enc_ffmpeg::fragment_manifest::FragmentManifestTracker;
use quiro_enc_ffmpeg::h264::{H264EncoderBuilder, H264Preset};
use quiro_enc_ffmpeg::h264_packet::EncodePacketError;
use quiro_enc_ffmpeg::segmented_stream::{DiskSpaceCallback, SegmentCompletedEvent};
    ...
    fn start_encoder(&mut self) -> anyhow::Result<()> {
        ...
        let encoder_handle = std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let encode_one =
                    |encoder: &mut quiro_enc_ffmpeg::h264_packet::H264PacketEncoder,
...
fn dispatch_packet(
    subprocess: &mut RespawningMuxerSubprocess,
    pkt: quiro_enc_ffmpeg::h264_packet::EncodedPacket,
