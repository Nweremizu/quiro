...
use anyhow::anyhow;
use cidre::arc;
use quiro_enc_avfoundation::QueueFrameError;
...
struct Mp4EncoderState {
    ...
    encoder: Arc<Mutex<quiro_enc_avfoundation::MP4Encoder>>,
...
impl Muxer for AVFoundationMp4Muxer {
    ...
    async fn setup(
        ...
        let encoder = if config.instant_mode {
            quiro_enc_avfoundation::MP4Encoder::init_instant_mode(
                output_path.clone(),
                video_config,
                audio_config,
            ...
            quiro_enc_avfoundation::MP4Encoder::init_ultra(
                output_path.clone(),
                video_config,
                audio_config,
                config.output_height,
            ...
            quiro_enc_avfoundation::MP4Encoder::init_compatibility(
                output_path.clone(),
                video_config,
                audio_config,
                config.output_height,
            ...
            quiro_enc_avfoundation::MP4Encoder::init(
                output_path.clone(),
                video_config,
                audio_config,
                config.output_height,
