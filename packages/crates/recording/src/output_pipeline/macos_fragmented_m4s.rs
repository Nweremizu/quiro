use super::core::{
    ...
    combine_finish_errors, frame_timing_log_threshold_ms, wait_for_blocking_thread_finish,
};
...
use quiro_enc_ffmpeg::segmented_stream::{
        ...
        let encoder_handle = std::thread::Builder::new()
            ...
            .spawn(move || {
                let pixel_format = match video_config.pixel_format {
                    quiro_media_info::Pixel::NV12 => ffmpeg::format::Pixel::NV12,
                    quiro_media_info::Pixel::BGRA => ffmpeg::format::Pixel::BGRA,
                    quiro_media_info::Pixel::UYVY422 => ffmpeg::format::Pixel::UYVY422,
