...
use quiro_cursor_capture::CursorCropBounds;
...
pub fn spawn_cursor_recorder(
    ...
    let thread = std::thread::spawn(move || {
        ...
        let mut last_position = quiro_cursor_capture::RawCursorPosition::get();
        ...
        loop {
            ...
            let position = quiro_cursor_capture::RawCursorPosition::get();
...
fn get_cursor_data() -> Option<CursorData> {
    ...
    autoreleasepool(|| unsafe {
        ...
        let shape =
            quiro_cursor_info::CursorShapeMacOS::from_hash(&hex::encode(Sha256::digest(&image)));
