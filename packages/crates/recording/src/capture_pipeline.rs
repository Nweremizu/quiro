...
use quiro_enc_ffmpeg::h264::H264EncoderBuilder;
#[cfg(target_os = "linux")]
use quiro_enc_ffmpeg::h264::H264Preset;
#[cfg(windows)]
use quiro_enc_ffmpeg::h264::H264Preset;
use quiro_enc_ffmpeg::segmented_stream::SegmentCompletedEvent;
...
impl MakeCapturePipeline for screen_capture::CMSampleBufferCapture {
    async fn make_studio_mode_pipeline(
        ...
        if fragmented {
            ...
            let preset = if ultra {
                quiro_enc_ffmpeg::h264::H264Preset::Medium
            } else {
                quiro_enc_ffmpeg::h264::H264Preset::Ultrafast
            };
...
-> windows::core::Result<windows::Win32::Graphics::Direct3D11::ID3D11Device> {
    ...
    if let Ok(selected) = quiro_d3d_adapter::select_capture_adapter(None) {
