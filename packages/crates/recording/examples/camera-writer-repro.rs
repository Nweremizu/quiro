...
fn main() -> anyhow::Result<()> {
    use cidre::{arc, cm};
    use quiro_camera::{CameraInfo, CapturedFrame, Format};
    use quiro_camera_ffmpeg::CapturedFrameExt;
    use quiro_enc_avfoundation::{MP4Encoder, QueueFrameError};
    ...
    fn collect_probe_targets(
        ...
        let cameras = quiro_camera::list_cameras().collect::<Vec<_>>();
