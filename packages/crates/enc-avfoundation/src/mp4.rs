...
use quiro_media_info::{AudioInfo, VideoInfo, ensure_even};
...
mod tests {
    use super::*;
    use quiro_media_info::RawVideoFormat;
    ...
    fn wireless_audio_config() -> quiro_media_info::AudioInfo {
        quiro_media_info::AudioInfo {
            sample_rate: 48000,
            channels: 1,
    ...
    fn wired_audio_config(buffer_size: u32) -> quiro_media_info::AudioInfo {
        quiro_media_info::AudioInfo {
            sample_rate: 48000,
            channels: 1,
            sample_format: ffmpeg::format::Sample::F32(ffmpeg::format::sample::Type::Packed),
    ...
    impl ThreadedEncoderHarness {
        fn new(
            output: PathBuf,
            video_config: VideoInfo,
            audio_config: Option<quiro_media_info::AudioInfo>,
            output_height: Option<u32>,
        ) -> Self {
            let encoder =
    ...
    fn run_raw_writer_with_duration_strategy(
        ...
        let output_height = quiro_media_info::ensure_even(video_config.height);
        let output_width = quiro_media_info::ensure_even(video_config.width);
        let fps = 30.0f32;
    ...
    fn setup_raw_writer(
        ...
        let output_width = quiro_media_info::ensure_even(width);
        let output_height = quiro_media_info::ensure_even(height);
