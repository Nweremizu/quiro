...
struct ActiveCaptionSegment<'a> {
    segment: &'a quiro_project::CaptionTrackSegment,
}

fn caption_segment_effective_end(segment: &quiro_project::CaptionTrackSegment) -> f64 {
...
fn find_active_caption_segment<'a>(
    time: f64,
    segments: &'a [quiro_project::CaptionTrackSegment],
...
mod tests {
    ...
    use quiro_project::{CaptionTrackSegment, CaptionWord};
