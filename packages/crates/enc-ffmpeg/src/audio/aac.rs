// aac.rs is an audio encoder for AAC format using ffmpeg library. It provides functionality to initialize the encoder, send audio frames, and flush the encoder.
...
use quiro_media_info::{AudioInfo, FFRational};
