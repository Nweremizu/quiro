...
use quiro_enc_ffmpeg::{mov::MOVFile, prores::ProResEncoder};
use quiro_media_info::{RawVideoFormat, VideoInfo};
use quiro_project::XY;
use quiro_rendering::{ProjectUniforms, RenderSegment, RenderedFrame};
...
impl MovExportSettings {
    pub async fn export(
        ...
        let render_video_task = quiro_rendering::render_video_to_channel(
