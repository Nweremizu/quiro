...
export function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      className={cn("px-2 py-1.5 text-sm font-semibold text-gray-11", inset && "pl-8", className)}
      {...props}
    />
  );
}
...
export function DropdownMenuSeparator({ className, ...props }: MenuPrimitive.Separator.Props) {
  return <MenuPrimitive.Separator className={cn("-mx-1 my-1 h-px bg-gray-4", className)} {...props} />;
}
