  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className={cn("zoom-end-cap left")}
            style={{ cursor: "col-resize", pointerEvents: "auto" }}
            title="Resize left"
          />
          <div
            className={cn("zoom-end-cap right")}
            style={{ cursor: "col-resize", pointerEvents: "auto" }}
            title="Resize right"
          />
          {/* Content */}
          <div className="relative z-10 flex flex-col items-center justify-center text-black/70 dark:text-white/90 opacity-80 group-hover:opacity-100 transition-opacity select-none overflow-hidden">
            <div className="flex items-center gap-1.5">
              {isZoom ? (
                <>
                  <ZoomInAreaIcon className="w-3.5 h-3.5 shrink-0" />
                ...
                <>
                  <ScissorIcon className="w-3.5 h-3.5 shrink-0" />
                  <span className="text-[11px] font-semibold tracking-tight whitespace-nowrap">
                    Trim
                  </span>
                </>
                ...
                <>
                  <DashboardSpeedIcon className="w-3.5 h-3.5 shrink-0" />
                  <span className="text-[11px] font-semibold tracking-tight whitespace-nowrap">
                ...
                <>
                  <MusicNote01Icon className="w-3.5 h-3.5 shrink-0" />
                ...
                <>
                  <BubbleChatIcon className="w-3.5 h-3.5 shrink-0" />
                  <span className="text-[11px] font-semibold tracking-tight whitespace-nowrap">
                    {children}
                  </span>
                </>
            ...
            {isZoom ? (
              ...
              >
                <MouseLeftClickIcon className="w-2.5 h-2.5 shrink-0" />
