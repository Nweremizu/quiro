...
export function getWebcamPositionForPreset(preset: WebcamPositionPreset): {
  x: number;
  y: number;
} {
  switch (preset) {
...
export function normalizeWebcamCropRegion(
...
export function isWebcamCropRegionDefault(
  cropRegion?: Partial<CropRegion> | null,
): boolean {
