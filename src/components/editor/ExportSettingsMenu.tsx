...
import { DownloadIcon, Film01Icon, ImageIcon } from "@/components/icons";
...
export function ExportSettingsMenu({
  ...
  return (
    <div
      className={cn(
        "w-full rounded-2xl border border-subtle bg-card/96 p-3 text-foreground backdrop-blur-xl",
        className,
      )}
    >
        ...
        <LayoutGroup id="header-export-format-toggle">
          {(
            [
              {
                value: "mp4",
                label: tSettings("export.mp4"),
                icon: Film01Icon,
              },
              { value: "gif", label: tSettings("export.gif"), icon: ImageIcon },
            ] as const
          ).map((option) => {
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? "border-[rgba(240,128,48,0.24)] text-accent-foreground dark:text-white bg-[rgba(240,128,48,0.14)] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"
      ...
      {exportFormat === "mp4" ? (
        <LayoutGroup id="header-export-quality-toggle">
          <div className="mb-3 grid min-h-12 w-full grid-cols-4 rounded-xl bg-foreground/5 border border-(--border-subtle) p-0.5">
            {(
              [
                ...
                {
                  value: "source",
                  label: tSettings("export.quality.original"),
                },
              ] as const
            ).map((option) => {
              ...
              return (
                <button
                  ...
                  aria-pressed={isActive}
                  className="relative rounded-lg px-1 py-1 text-[11px] font-medium transition-colors tabular-nums"
                >
                  {isActive ? (
                    <motion.span
                      layoutId="header-export-quality-pill"
                      className="absolute inset-0 rounded-lg bg-card  border-primary/10"
                      transition={{
                        type: "spring",
                        stiffness: 420,
                        damping: 34,
          ...
          <div className="mb-3 grid min-h-10 w-full grid-cols-3 rounded-xl bg-foreground/5 border border-(--border-subtle) p-0.5">
            {(
              [
                {
                  value: "fast",
                  label: tSettings("export.encoding.fast", "Fast"),
                },
                {
                  value: "balanced",
          ...
          <div className="flex items-center justify-between px-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <Switch
                ...
                className="scale-85 data-[state=checked]:bg-primary"
              />
            </div>
          </div>
        </div>
