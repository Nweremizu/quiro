/**
 * Quiro Extension System — Core Types
 *
...
// ---------------------------------------------------------------------------
// Extension Manifest (quiro-extension.json)
// ---------------------------------------------------------------------------
...
export interface ExtensionManifest {
  ...
  license?: string;
  /** Minimum Quiro version required */
  engine?: string;
 ...
 *
 * Quiro does not auto-register these entries at runtime today.
...
export interface RenderHookContext {
   ...
   */
  getEdgeAverageColor(edgeWidth?: number): {
    r: number;
    g: number;
    b: number;
    a: number;
...
export interface QuiroExtensionAPI {
...
export interface QuiroExtensionModule {
  /** Called when the extension is activated */
  activate(api: QuiroExtensionAPI): void | Promise<void>;
